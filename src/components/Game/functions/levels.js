...
const levels = [
  [
    //level 1
    [
      <Component shape={"I"} id={1} tileData={[true, null, true, null]} rotation={0} startingTile={true} />,
      <Component shape={"EMPTY"} id={2} tileData={[null, null, null, null]} rotation={0} />,
      <Component shape={"EMPTY"} id={3} tileData={[null, null, null, null]} rotation={0} />
    ],
    [
      <Component shape={"I"} id={4} tileData={[null, true, null, true]} rotation={90} />,
      <Component shape={"EMPTY"} id={5} tileData={[null, null, null, null]} rotation={0} />,
      <Component shape={"EMPTY"} id={6} tileData={[null, null, null, null]} rotation={0} />
    ],
    [
      <Component shape={"L"} id={7} tileData={[true, null, null, true]} rotation={180} />,
      <Component shape={"I"} id={8} tileData={[true, null, true, null]} rotation={0} />,
  ...
  [
    //level 2
    [
      <Component shape={"L"} id={1} tileData={[true, true, null, null]} rotation={270} startingTile={true} />,
  ...
  [
    ...
    [
      ...
      <Component shape={"L"} id={6} tileData={[true, null, null, true]} rotation={180} />,
      <Component shape={"EMPTY"} id={7} tileData={[null, null, null, null]} rotation={0} />,
      <Component shape={"I"} id={8} tileData={[null, true, null, true]} rotation={90} />
    ],
    [
      <Component shape={"EMPTY"} id={9} tileData={[null, null, null, null]} rotation={0} />,
    ...
    [
      <Component shape={"EMPTY"} id={13} tileData={[null, null, null, null]} rotation={0} />,
      <Component shape={"L"} id={14} tileData={[null, null, true, true]} rotation={90} />,
